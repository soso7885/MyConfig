...
let s:cdWireBlue = {'gui': '#223E55', 'cterm': s:cterm0D, 'cterm256': '27'}
let s:cdLightWireBlue = {'gui': '#223E55', 'cterm': s:cterm0D, 'cterm256': '39'}
...
call <sid>hi('Macro', s:cdLightWireBlue, {}, 'none', {})
call <sid>hi('PreCondit', s:cdWireBlue, {}, 'none', {})
...
call <sid>hi('Todo', s:cdRed, s:cdYellow, 'undercurl', {})
